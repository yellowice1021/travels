			...
			<div class="register_main_container">
				...
				<div class="main_header clearfix">
					<div class="float_right">
						<span>已有账号了？</span>
						<a class="button" href="login.jsp">立即登录</a>
					</div>
				</div>
				<!--注册框-->
				<div class="main_box">
						...
						<form name="registerForm" ng-cloak>
							<ul>
								<li>
									...
									<span ng-show="registerForm.username.$error.required&&registerForm.username.$dirty" class="register_info_box">用户名不能为空</span>
									<span ng-show="registerForm.username.$error.maxlength" class="register_info_box">用户名长度不能大于10字符</span>
								</li>
								<li>
									<span class="name_text">
										<i>*</i>
									...
									<span ng-show="registerForm.passwords.$error.required&&registerForm.passwords.$dirty" class="register_info_box">密码不能为空</span>
								</li>
								<li>
									<span class="name_text">
										<i>*</i>
									...
									<span ng-show="registerForm.surePasswords.$error.required&&registerForm.surePasswords.$dirty" class="register_info_box">请再次输入密码</span>
									<span ng-show="person.passwords!=person.surePasswords&&registerForm.surePasswords.$dirty&&!registerForm.surePasswords.$error.required" class="register_info_box">两次密码输入不一致，请重新输入</span>
								</li>
								<li>
									<span class="name_text">
										<i>*</i>
									...
									<span ng-show="registerForm.verifyCode.$error.required&&registerForm.verifyCode.$dirty" class="register_info_box">验证码不能为空</span>
